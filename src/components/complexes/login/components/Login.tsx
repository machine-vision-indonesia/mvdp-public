    ...
    <>
      <div style={{ display: 'flex', height: '100vh', width: '100%' }}>
        ...
        <div style={{ flexBasis: '50%', display: 'flex', alignItems: 'center', position: 'relative' }}>
          <Box sx={{ width: '100%', maxWidth: 500, margin: 'auto' }}>
            <Box>
              <MvTypography size='TITLE_MD' typeSize='PX' mb={2}>
                Hello Again!
              </MvTypography>

              <MvTypography size='BODY_SM_NORMAL' typeSize='PX' mb={5}>
                Welcome back
              </MvTypography>
            </Box>
            {errorMessage ? (
            ...
            <FormLogin setErrorMessage={setErrorMessage} />
      ...
      >
        <Box sx={{ mb: 4, textAlign: 'center' }}>
          ...
          <MvTypography size='LABEL_MD_NORMAL' typeSize='PX'>
            Do you want to log out of other devices?
          </MvTypography>
        </Box>
      </Modal>

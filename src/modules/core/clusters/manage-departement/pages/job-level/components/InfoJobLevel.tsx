...
import { SectionProps } from '../types/ManageJobLevelPage.types'

const InfoJobLevel: React.FC<SectionProps> = ({ title, fields, renderEditButton }) => {

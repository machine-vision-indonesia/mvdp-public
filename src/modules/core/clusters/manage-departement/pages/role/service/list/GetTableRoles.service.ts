...
import { PropsTable } from '../../types/ManageRolePage.types'
      ...
      _and: [
        ...
        },
        {
          _and: [
            {
              parent: {
                _in: params?.filterResult?.resultController?.['parent.name']?.[0]?.id ?? undefined
              }
            }
          ]
        },
        {
          _or: [
            {
              code: {
                _icontains: params?.filterResult?.resultController?.['code'] || undefined
              }
            },
            {
              name: {

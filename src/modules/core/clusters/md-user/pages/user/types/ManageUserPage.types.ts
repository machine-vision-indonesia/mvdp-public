...
import { TypeHistoricalData } from '@/components/molecules/historical'
...
export interface ProfileSummaryProps {
  ...
  watchJobLevel: { label?: string }
  watchJobTitle: { label?: string }
  watchIdNumber: string
  watchFirstName: string
  watchLastName: string
  watchGenderLabel: string | undefined
  watchReligionLabel: string | undefined
  watchPhone?: string
...
export type UserLogActivityParams = {
  user_id: string
  enabled: boolean
  page?: number
}
...
export type UserLogActivityProps = {
  userLogs: UserLog[]
}
...
export type GetUserLogActivityResponseData = {
  id: number
  collection: string
  item: string
  delta: any
...
export type GetUserLogActivityQueryResponse = {
  data: GetUserLogActivityResponseData[]
  meta: Meta
}

...
import {
  schemaAddressContact,
  schemaEditPersonalData,
  schemaFile,
  schemaJobProfile,
  schemaPersonalData,
  schemaProfileOtp
...
export type SchemaEditPersonalData = yup.InferType<typeof schemaEditPersonalData>

export type SchemaJobProfile = yup.InferType<typeof schemaJobProfile>
...
export type SchemaProfileOtp = yup.InferType<typeof schemaProfileOtp>
export interface propsOnTwoAuth {
  loginOption: 'disable' | 'enable'
}

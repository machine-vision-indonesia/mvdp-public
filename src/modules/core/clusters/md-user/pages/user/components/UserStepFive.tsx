  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', rowGap: '20px' }}>
        ...
        >
          ...
          <div style={{ alignSelf: 'flex-end' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', columnGap: '13px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', columnGap: '5px', marginTop: '5px' }}>
                <Icon icon='mingcute:navigation-line' color='#5D5E61' fontSize='20px' />
                <MvTypography size='BODY_SM_NORMAL' typeSize='PX'>
                  {watchAddress || '-'}
                </MvTypography>
              </div>
      ...
      <InfoProfile
        title='Job Profile'
        fields={[
          { label: 'Role', value: watchRoles.map(role => role.label) },
          { label: 'Job Title', value: watchJobTitle?.label ?? '-' },
          ...
          { label: 'Job Level', value: watchJobLevel?.label ?? '-' }
        ]}
      />
      <InfoProfile
